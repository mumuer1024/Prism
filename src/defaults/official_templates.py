...
""",
    ...
    {
        "title": "效率工具机会扫描",
        "description": "扫描 Chrome 扩展商店中的效率工具类别，寻找可优化或重写的机会。",
        "tool_type": "bounty_chrome",
        "prompt_content": """扫描 Chrome 扩展商店「生产力工具」类别，寻找"丑小鸭"机会。
...
- 建议行动
""",
        "tags": ["效率", "生产力", "工具", "Chrome"],
        "is_official": True,
        "is_published": True,
    },
    {
        "title": "开发者工具机会扫描",
        "description": "扫描 Chrome 扩展商店中的开发者工具类别，寻找技术向的商机。",
        "tool_type": "bounty_chrome",
        "prompt_content": """扫描 Chrome 扩展商店「开发者工具」类别，寻找"丑小鸭"机会。
